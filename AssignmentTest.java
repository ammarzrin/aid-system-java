...
public class AssignmentTest {
    ...
    void login(){
        try{
            InputStream input = new FileInputStream("C:\\Users\\ASUS\\Desktop\\Assignment\\AssignmentTest.txt");
            BufferedReader reader = new BufferedReader(new InputStreamReader(input));
            System.out.println("\nL O G I N\n");
            System.out.print("Enter username :");
            a.getUsername(s.next()); 
            System.out.print("Enter password :");
            a.getPassword(s.next());
            String _temp=null;
            String _user;
            String _pass;
            boolean found = false;
        ...
        void createaccount(){
            try{
                OutputStream output = new BufferedOutputStream(new FileOutputStream("C:\\Users\\ASUS\\Desktop\\Assignment\\AssignmentTest.txt"));
